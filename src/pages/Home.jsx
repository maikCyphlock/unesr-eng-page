    ...
    <section class="bg-gray-900 text-white ">
      ...
      >
        <div class="mx-auto max-w-5xl text-center">
          <h1
            class="bg-gradient-to-t  from-cyan-600 via-cyan-500 to-indigo-600 bg-clip-text text-3xl font-extrabold text-transparent sm:text-7xl"
          >
            Universidad Simón Rodriguez
    
            <span class="sm:block "> Docencia en Inglés </span>
          </h1>
    
          <p class="mx-auto mt-8 max-w-xl sm:text-xl sm:leading-relaxed">
            Sitio informativo para los estudiantes de la docencia en inglés y recursos para el estudio
          </p>
      ...
      <div class="max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        >
          <div class="mx-auto max-w-lg text-center lg:mx-0 lg:text-left">
            <h2 class="text-3xl font-bold sm:text-4xl">Encuentra recursos e información</h2>
          ...
          <Link to={'/course/hola'} >
            ...
            >
              ...
              <h2 class="mt-2 font-bold">Inglés instrumental</h2>
    ...
    <footer aria-label="Site Footer" class="bg-gray-100">
      <div class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        <div class="flex justify-center text-blue-400">
         <img src="https://universidadesgratuitas.com/wp-content/uploads/2020/02/escudo-UNESR.png" class=" w-20" alt=""/>
        </div>
